...
class Links:
    oauth_api = ("https://account-public-service-prod.ol.epicgames.com/"
                 + "account/api/oauth/{0}")
    profile_api = ("https://fortnite-public-service-prod11.ol.epicgames.com/"
                   + "fortnite/api/game/v2/profile/{0}/client/{1}?profileId={2}")
    auth_code = ("https://www.epicgames.com/id/api/redirect?clientId="
                 + "34a02cf8f4414e29b15921876da36f9a&responseType=code")

class Headers:
    access = ("basic MzRhMDJjZjhmNDQxNGUyOWIxNTkyMTg3NmRhMzZmOWE6"
              + "ZGFhZmJjY2M3Mzc3NDUwMzlkZmZlNTNkOTRmYzc2Y2Y=")
    oauth = ("basic MzQ0NmNkNzI2OTRjNGE0NDg1ZDgxYjc3YWRiYjIxNDE6O"
...
def read_jsons():
    ...
    if not os.path.exists(fn_path):
        input("ERROR: fortnite.json file doesn't exist. Get "
              + "it from this program's repository on GitHub: https://github.com/zdky/questreroll")
        sys.exit()
